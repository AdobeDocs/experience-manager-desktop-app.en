...
The release information for the latest desktop app version 2.2.1 is below. The release date is February 10, 2023.

The latest version of the desktop app includes the following bug fixes:

* desktop app displays session timeout error message when you click **[!UICONTROL Sign In]**.

* Issues while accessing desktop app v2.2.0 on macOS.

* desktop app displays an error message when you sort assets by clicking **[!UICONTROL Edited Locally]**.
