...
| Type          | Minor release                                                                                                                                                                                                                                          |
| Date          | August 31, 2018                                                                                                                                                                                                                                        |
| Download URLs |  [Mac OS X 64 bit](http://download.macromedia.com/aem-assets-companion-app/aem-desktop-osx-1.10.0.3.dmg); [Windows 32 bit](http://download.macromedia.com/aem-assets-companion-app/aem-desktop-win32-1.10.0.3.exe); [Windows 64 bit](http://download.macromedia.com/aem-assets-companion-app/aem-desktop-win64-1.10.0.3.exe) |
